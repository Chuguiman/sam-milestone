...
class SubscriptionManagerService
{
    ...
    protected function applyMaxCountriesLimit(Organization $organization, int $maxCountries)
    {
        ...
        // Esta función está preparada para cuando implementes la funcionalidad de países monitoreados
        // Puedes extenderla cuando crees tu modelo de países monitoreados
        // Por ejemplo:
        
        // Si tienes una tabla 'monitored_countries' o similar:
        // if (Schema::hasTable('monitored_countries')) {
        //     $currentCountries = DB::table('monitored_countries')
        //         ->where('organization_id', $organization->id)
        //         ->count();
        //         
        //     if ($currentCountries > $maxCountries && $maxCountries > 0) {
        //         $countriesToKeep = DB::table('monitored_countries')
        //             ->where('organization_id', $organization->id)
        //             ->orderBy('created_at', 'asc')
        //             ->limit($maxCountries)
        //             ->pluck('id');
        //             
        //         DB::table('monitored_countries')
        //             ->where('organization_id', $organization->id)
        //             ->whereNotIn('id', $countriesToKeep)
        //             ->delete();
        //     }
        // }
    }
    ...
    public function hasReachedCountryLimit(Organization $organization)
    {
        ...
        // Puedes implementar la verificación cuando tengas el modelo de países monitoreados
        // Por ejemplo:
        // if (Schema::hasTable('monitored_countries')) {
        //     $currentCountries = DB::table('monitored_countries')
        //         ->where('organization_id', $organization->id)
        //         ->count();
        //     
        //     return $currentCountries >= $maxCountries;
        // }
        
        return false; // Por defecto no hay límite hasta que implementes el modelo
    }
